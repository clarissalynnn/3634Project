...
public class HealthyDiet {
    ...
    public static ArrayList<HealthyDiet> getHealthyDiet() {
        ...
        healthyDiets.add(new HealthyDiet("Gluten Free Diet","Following a gluten free diet means eliminating gluten, the proteins found in wheat and some other grains. There are no other requirements, so a gluten free diet is not necessarily a healthy diet, since you could easily load up on gluten free pasta, cookies, and crackers. This is why a gluten free diet mostly makes sense if you truly have a gluten allergy or insensitivity, or if you cut out gluten while centering your diet around unprocessed foods.","Everything that doesn't contain gluten","Gluten-containing grains, such as wheat, barley, and rye, as well as any foods made from them"));
        healthyDiets.add(new HealthyDiet("Grain Free Diet","The difference between gluten free and grain free is simple: a gluten free diet avoids grains that contain gluten, while a grain free diet avoids all grains, even those that do not contain gluten. This means a grain free diet is a gluten free diet (because it does not include wheat or gluten-containing grains), but a gluten free diet is not necessarily a grain free diet (because it can include grains that do not contain gluten, such as rice and corn.)\n" +
                "\n" +
